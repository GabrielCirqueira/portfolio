...
export function ProjetoModalDesktop({ isOpen, onClose, projeto }: ProjetoModalProps) {
                  ...
                  <HStack className="justify-between items-start gap-3">
                    <VStack className="gap-2 flex-1 min-w-0">
                      ...
                      <HStack className="items-center gap-2 flex-wrap hidden md:flex">
                        <HStack className="items-center gap-2 text-xs text-zinc-300 font-mono bg-zinc-900/80 border border-zinc-800 px-2.5 py-1.5 rounded-lg">
                    ...
                    <Button
                      onClick={onClose}
                      className="bg-zinc-900 border border-zinc-700 hover:border-brand-500 hover:bg-brand-600 hover:text-black text-white transition-all duration-300 rounded-lg w-8 h-8 md:w-9 md:h-9 p-0 flex items-center justify-center flex-shrink-0"
                    >
                      ...
                      <Box className="relative w-full overflow-hidden rounded-lg border border-zinc-800 bg-gradient-to-br from-zinc-900 to-zinc-950 shadow-lg group">
                        ...
                        <Box className="relative w-full min-h-[180px] sm:min-h-[220px] md:min-h-[280px] lg:min-h-[350px] flex items-center justify-center p-2 sm:p-3">
                          ...
                          <Button
                            ...
                            className="absolute top-2 right-2 z-[3] bg-zinc-900/90 border border-brand-500/30 text-brand-400 hover:bg-brand-500 hover:text-black hover:border-brand-500 transition-all duration-300 rounded-lg w-10 h-10 p-0 flex items-center justify-center shadow-lg shadow-brand-500/10 hover:shadow-brand-500/40"
                          >
                    ...
                    <VStack className="gap-3">
                      ...
                      <HStack className="flex-wrap gap-2">
                        {projeto.tecnologias.map((tech) => (
                          <Badge
                            key={tech}
                            className="bg-zinc-900 text-brand-300 border border-brand-500/20 px-2.5 md:px-3 py-1 md:py-1.5 text-xs font-mono uppercase tracking-wider rounded-lg transition-all duration-300 hover:border-brand-500/50 hover:bg-zinc-800"
                          >
                            {tech}
                          </Badge>
                        ))}
        ...
        {imagemExpandida && (
          ...
          >
            ...
            >
              <Button
                onClick={() => setImagemExpandida(null)}
                className="absolute top-2 right-2 z-10 bg-black/80 border border-zinc-700 hover:border-brand-500 hover:bg-brand-600 hover:text-black text-white transition-all duration-300 rounded-lg w-10 h-10 p-0 flex items-center justify-center shadow-lg"
              >
