                ...
                <VStack className="relative z-10 p-6 sm:p-8 gap-6 text-center items-center">
                  ...
                  <VStack className="gap-2 w-full">
                    <Title className="text-2xl w-full sm:text-3xl text-center font-bold font-heading text-white tracking-tight">
                      Abrir <span className="text-brand-400">WhatsApp</span>
                    </Title>
                  ...
                  <Box className="w-full bg-zinc-900/50 border border-brand-500/20 rounded-lg p-3">
                    <Text className="text-brand-400 text-center font-mono text-sm md:text-base tracking-wider">
                      +55 27 99612-1313
                    </Text>
                  </Box>
