...
import { ProjectCard } from '@/components/responsive/ProjectCard'
        ...
        <VStack className="gap-32">
          <Box>
            ...
            >
              ...
              <TypographyText className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold uppercase tracking-wider font-heading text-white">
                Sistemas Web
              </TypographyText>
            ...
            >
              {sistemas.map((projeto) => (
                <ProjectCard key={projeto.id} projeto={projeto} onAbrirModal={abrirModal} />
              ))}
            </motion.div>
          </Box>
