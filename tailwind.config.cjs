...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'hard-1': '-2px 2px 8px 0px rgba(16, 185, 129, 0.15)',
        'hard-2': '0px 3px 10px 0px rgba(16, 185, 129, 0.20)',
        'hard-3': '2px 2px 8px 0px rgba(16, 185, 129, 0.15)',
        'hard-4': '0px -3px 10px 0px rgba(16, 185, 129, 0.20)',
        'hard-5': '0px 2px 10px 0px rgba(16, 185, 129, 0.10)',
        'soft-1': '0px 0px 10px rgba(16, 185, 129, 0.1)',
